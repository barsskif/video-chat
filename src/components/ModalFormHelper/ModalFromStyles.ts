...
export const StyledTextFieldModal = styled(TextField)<{ height?: string; fontSize?: string }>(
...
export const TextareaStyledModal = styled('textarea')(({theme}) => ({
  fontSize: '20px',
  resize: 'vertical',
  borderRadius: '28px',
...
export const ButtonStyledModal = styled(Button)(({theme}) => ({
    fontSize: '20px',
